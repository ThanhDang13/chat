...
export class UserConnectedEvent
  implements Event<typeof UserConnectedEvent.type, UserConnectedEventdPayload>
{
...
export class UserDisconnectedEvent
  implements Event<typeof UserDisconnectedEvent.type, UserDisconnectedEventPayload>
{
...
export class ConversationReadUpdateEvent
  implements Event<typeof ConversationReadUpdateEvent.type, ConversationReadUpdateEventPayload>
{
